...
To create a new project, use the `+` button in the bottom right of the home screen. You will be prompted to enter a project name, a project description, and main catalog format.
